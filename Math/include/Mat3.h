...
namespace Axiom
{
	...
	public:
		// Big 4
		Mat3();
		Mat3 &operator=(const Mat3 &A) = default;
		Mat3(const Mat3 &tM) = default;
		~Mat3() = default;
		...
		Mat3(const float m0, const float m1, const float m2, const float m4, const float m5, const float m6, const float m8, const float m9, const float m10);
