...
/* @@protoc_insertion_point(class_definition:textureData_proto) */ {
 ...
 public:
  ...
  // accessors -------------------------------------------------------
  enum : int {
    kFileNameDataFieldNumber = 14,
    kPoDataFieldNumber = 16,
    kPVersionFieldNumber = 17,
    kTextTypeFieldNumber = 1,
    kMagFilterFieldNumber = 2,
    kMinFilterFieldNumber = 3,
    kWrapSFieldNumber = 4,
    kWrapTFieldNumber = 5,
    kEFormatFieldNumber = 6,
    kNComponentFieldNumber = 7,
    kWidthFieldNumber = 8,
    kHeightFieldNumber = 9,
    kComponentFieldNumber = 10,
    kBitsFieldNumber = 11,
    kPixelTypeFieldNumber = 12,
    kFileNameSizeFieldNumber = 13,
    kDataSizeFieldNumber = 15,
    kMd5FieldNumber = 18,
    kEnabledFieldNumber = 19,
    kAsIsFieldNumber = 20,
  };
  ...
  void clear_md5() ;
  ::uint32_t md5() const;
  void set_md5(::uint32_t value);

  private:
  ::uint32_t _internal_md5() const;
  void _internal_set_md5(::uint32_t value);
...
// optional uint32 md5 = 18;
inline bool textureData_proto::has_md5() const {
...
inline ::uint32_t textureData_proto::md5() const {
  // @@protoc_insertion_point(field_get:textureData_proto.md5)
  return _internal_md5();
}
inline void textureData_proto::set_md5(::uint32_t value) {
  _internal_set_md5(value);
  _impl_._has_bits_[0] |= 0x00020000u;
  // @@protoc_insertion_point(field_set:textureData_proto.md5)
}
inline ::uint32_t textureData_proto::_internal_md5() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.md5_;
}
inline void textureData_proto::_internal_set_md5(::uint32_t value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.md5_ = value;
}
...
inline bool textureData_proto::as_is() const {
  // @@protoc_insertion_point(field_get:textureData_proto.as_is)
  return _internal_as_is();
}
inline void textureData_proto::set_as_is(bool value) {
  _internal_set_as_is(value);
  _impl_._has_bits_[0] |= 0x00080000u;
  // @@protoc_insertion_point(field_set:textureData_proto.as_is)
}
inline bool textureData_proto::_internal_as_is() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.as_is_;
}
inline void textureData_proto::_internal_set_as_is(bool value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.as_is_ = value;
}
